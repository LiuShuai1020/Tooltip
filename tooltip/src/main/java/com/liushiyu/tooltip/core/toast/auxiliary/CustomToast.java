package com.liushiyu.tooltip.core.toast.auxiliary;
...
import static com.liushiyu.tooltip.core.toast.auxiliary.UniversalToast.Duration;
import static com.liushiyu.tooltip.core.toast.auxiliary.UniversalToast.Type;

import static android.os.Build.VERSION_CODES.JELLY_BEAN;
import static android.os.Build.VERSION_CODES.JELLY_BEAN_MR1;
import static com.liushiyu.tooltip.core.toast.auxiliary.UniversalToast.CLICKABLE;
import static com.liushiyu.tooltip.core.toast.auxiliary.UniversalToast.EMPHASIZE;
import static com.liushiyu.tooltip.core.toast.auxiliary.UniversalToast.UNIVERSAL;
    ...
    public void show() {
        ...
        mShowRunnable = new Runnable() {
            ...
            public void run() {
                ...
                ImageView draweeView = mView.findViewById(R.id.icon);
                if (mLeftGifUri != null) {
...
//                    draweeView.setVisibility(View.VISIBLE);
                    ...
                    draweeView.setBackgroundResource(mLeftIconRes);
                    draweeView.setVisibility(View.VISIBLE);
                }
